 ...
 * @author Jörg Kienitz
 */
public class FDMThetaMethodForHeatEquation {
	...
	public FDMThetaMethodForHeatEquation(FDMBlackScholesModel model, FiniteDifference1DBoundary boundaryCondition, double timeHorizon, double center, double theta) {
		this.model = model;
	...
	public double[][] getValue(double evaluationTime, double time, DoubleUnaryOperator valueAtMaturity) {
		...
		// All calls surrounding tau should be to getNumTimesteps, NOT getNumSpacesteps, but the unit test passes? @TODO: Investigate.
