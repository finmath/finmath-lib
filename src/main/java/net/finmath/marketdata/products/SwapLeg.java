 ...
 * @version 1.0
 */
public class SwapLeg extends AbstractAnalyticProduct implements AnalyticProductInterface, Serializable {
	 ...
	 */
	public SwapLeg(LocalDateTime cashFlowEffectiveDate, ScheduleInterface legSchedule, String forwardCurveName, double[] notionals, double[] spreads, String discountCurveName, boolean isNotionalExchanged) {
		super();
	...
	public double getValue(double evaluationTime, AnalyticModelInterface model) {
		...
		double cashFlowEffectiveTime = cashFlowEffectiveDate != null ? FloatingpointDate.getFloatingPointDateFromDate(LocalDateTime.of(modelReferenceDate, LocalTime.of(0,0)), cashFlowEffectiveDate) : evaluationTime;
