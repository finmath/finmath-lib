 ...
 */
public class InhomogenousBachelierModel extends AbstractModel {
	...
	public RandomVariableInterface[] getFactorLoading(int timeIndex, int component, RandomVariableInterface[] realizationAtTimeIndex) {
		double dt = getProcess().getTimeDiscretization().getTimeStep(timeIndex);
		RandomVariableInterface volatilityOnPaths = getRandomVariableForConstant(volatility * Math.sqrt((Math.exp(2.0*riskFreeRate*dt)-1.0)/(2.0*riskFreeRate*dt))	);
