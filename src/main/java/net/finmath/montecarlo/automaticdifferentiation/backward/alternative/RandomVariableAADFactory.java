...
public class RandomVariableAADFactory extends AbstractRandomVariableFactory {
	 ...
	 */
	public RandomVariableWithAAD constructNewAADRandomVariable(RandomVariableInterface randomVariable, int[] parentIndices,
	...
	public RandomVariableWithAAD constructNewAADRandomVariable(double value){
	...
	public RandomVariableWithAAD constructNewAADRandomVariable(RandomVariableInterface randomVariable) {
		return constructNewAADRandomVariable(randomVariable, /* no parents*/ null,
				/*no parent operator*/ null, /*no childrenIndices*/ null, /*not constant*/ false);
	}

	public RandomVariableWithAAD constructNewAADRandomVariable(double time, double[] realisations) {
	 ...
	 * @version 1.0
	 */
	public class RandomVariableWithAAD implements RandomVariableInterface {
		 ...
		 * @param isConstant
		 */
		private RandomVariableWithAAD(int ownIndexInList, RandomVariableInterface ownRandomVariable, 
		...
		private RandomVariableWithAAD[] getParentAADRandomVariables(){

			if(getParentIDs() == null) return null;

			int[] parentIndices = getParentIDs();
			RandomVariableWithAAD[] parentAADRandomVariables = new RandomVariableWithAAD[getNumberOfParentVariables()];
		...
		private RandomVariableInterface[] getParentRandomVariableInderfaces(){
			...
			RandomVariableWithAAD[] parentAADRandomVariables = getParentAADRandomVariables();
		...
		private RandomVariableInterface apply(OperatorType operator, RandomVariableInterface[] randomVariableInterfaces){
			...
			RandomVariableWithAAD[] aadRandomVariables = new RandomVariableWithAAD[randomVariableInterfaces.length];
			...
			for(int randomVariableIndex = 0; randomVariableIndex < randomVariableInterfaces.length; randomVariableIndex++){
				...
				aadRandomVariables[randomVariableIndex] = (randomVariableInterfaces[randomVariableIndex] instanceof RandomVariableWithAAD) ?
						(RandomVariableWithAAD)randomVariableInterfaces[randomVariableIndex] : constructNewAADRandomVariable(randomVariableInterfaces[randomVariableIndex]);
			...
			RandomVariableWithAAD newRandomVariableAAD =  constructNewAADRandomVariable(resultrandomvariable, futureParentIndices, operator, /*no children*/ null ,/*not constant*/ false);

			/* add new variable (or at least its index) as child to its parents */
			for(RandomVariableWithAAD parentRandomVariable:aadRandomVariables) 
		...
		private RandomVariableWithAAD getAADRandomVariableFromList(int index){
		...
		public double getMin() {
			return ((RandomVariableWithAAD) getMinAsRandomVariableAAD()).getRandomVariableInterface().getAverage();
		}
		...
		public double getMax() {
			return ((RandomVariableWithAAD) getMaxAsRandomVariableAAD()).getRandomVariableInterface().getAverage();
		}
		...
		public double getAverage() {		
			return ((RandomVariableWithAAD) getAverageAsRandomVariableAAD()).getRandomVariableInterface().getAverage();
		}
		...
		public double getAverage(RandomVariableInterface probabilities) {
			return ((RandomVariableWithAAD) getAverageAsRandomVariableAAD(probabilities)).getRandomVariableInterface().getAverage();
		}
		...
		public double getVariance() {
			return ((RandomVariableWithAAD) getVarianceAsRandomVariableAAD()).getRandomVariableInterface().getAverage();
		}
		...
		public double getSampleVariance() {
			return ((RandomVariableWithAAD) getSampleVarianceAsRandomVariableAAD()).getRandomVariableInterface().getAverage();
		}
		...
		public double getStandardDeviation() {
			return ((RandomVariableWithAAD) getStandardDeviationAsRandomVariableAAD()).getRandomVariableInterface().getAverage();
		}
		...
		public double getStandardDeviation(RandomVariableInterface probabilities) {
			return ((RandomVariableWithAAD) getStandardDeviationAsRandomVariableAAD(probabilities)).getRandomVariableInterface().getAverage();
		}
		...
		public double getStandardError() {
			return ((RandomVariableWithAAD) getStandardErrorAsRandomVariableAAD()).getRandomVariableInterface().getAverage();
		}
		...
		public double getStandardError(RandomVariableInterface probabilities) {
			return ((RandomVariableWithAAD) getStandardErrorAsRandomVariableAAD(probabilities)).getRandomVariableInterface().getAverage();
		}
		...
		public double getQuantile(double quantile) {
			return ((RandomVariableWithAAD) getRandomVariableInterface()).getRandomVariableInterface().getQuantile(quantile);
		}
		...
		public double getQuantile(double quantile, RandomVariableInterface probabilities) {
			return ((RandomVariableWithAAD) getRandomVariableInterface()).getRandomVariableInterface().getQuantile(quantile, probabilities);
		}
		...
		public double getQuantileExpectation(double quantileStart, double quantileEnd) {
			return ((RandomVariableWithAAD) getRandomVariableInterface()).getRandomVariableInterface().getQuantileExpectation(quantileStart, quantileEnd);
		}
