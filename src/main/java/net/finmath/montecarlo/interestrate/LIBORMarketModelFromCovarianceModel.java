 ...
 * {@link net.finmath.montecarlo.interestrate.modelplugins.AbstractLIBORCovarianceModelParametric#getCloneCalibrated(LIBORMarketModel, AbstractLIBORMonteCarloProduct[], double[], double[], Map)}.
 *
...
public class LIBORMarketModelFromCovarianceModel extends AbstractProcessModel implements LIBORMarketModel, Serializable {
	 ...
	 *
	 *
	 * @see net.finmath.montecarlo.interestrate.LIBORMarketModelFromCovarianceModel#getNumeraire(double) The calculation of the drift is consistent with the calculation of the numeraire in <code>getNumeraire</code>.
	 * @see net.finmath.montecarlo.interestrate.LIBORMarketModelFromCovarianceModel#getFactorLoading(int, int, RandomVariable[]) The factor loading \( \lambda_{j,k} \).
	 *
	...
	public Map<String, RandomVariable> getModelParameters() {
		...
		if(covarianceModel instanceof net.finmath.montecarlo.interestrate.covariancemodels.AbstractLIBORCovarianceModelParametric) {
			RandomVariable[] covarianceModelParameters = ((net.finmath.montecarlo.interestrate.covariancemodels.AbstractLIBORCovarianceModelParametric) covarianceModel).getParameter();
