 ...
 *
 * NOTE: Classes in this package are almost identical to the package net.finmath.montecarlo.interestrate.models.modelplugins except that the parameter may be a RandomVariable.
