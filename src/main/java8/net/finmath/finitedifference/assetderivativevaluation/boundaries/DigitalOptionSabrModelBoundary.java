 ...
 * are imposed only in the asset direction. In the volatility direction, no
 * explicit
 ...
 */
public class DigitalOptionSabrModelBoundary implements FiniteDifferenceBoundary {
	 ...
	 * {@link FDMSabrModel}.
	 *
	 * @param model The SABR model used to determine
	 *              risk-free and dividend discount factors.
	 */
	public DigitalOptionSabrModelBoundary(final FDMSabrModel model) {
		this.model = model;
	}
	...
	/**
	 * Returns the discounted asset asymptotic value for a European
	 * asset-or-nothing digital.
	 *
	 * @param stateVariable The boundary asset level.
	 * @param option The digital option.
	 * @param time The current model time.
	 * @return Discounted asset value.
	 */
