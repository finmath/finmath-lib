...
public class CashSettledPayerSwaption extends AbstractSingleSwapRateProduct {
	 ...
	 */
	public CashSettledPayerSwaption(final Schedule fixSchedule, final Schedule floatSchedule, final double strike, final String discountCurveName,
	...
	protected double payoffFunction(final double swapRate, final AnnuityMapping annuityMapping, final VolatilityCubeModel model) {
		double value = Math.max(swapRate -strike, 0.0);
