...
public class BondWithForeignNumeraire extends HybridAssetMonteCarloProduct {
	...
	public RandomVariable getValue(final double evaluationTime, final HybridAssetMonteCarloSimulation model) throws CalculationException {
		...
		final RandomVariable	numeraire				= model.getNumeraire(account, productToModelTimeOffset + maturity);
		...
		final RandomVariable	numeraireAtEvaluationTime				= model.getNumeraire(account, evaluationTime);
