...
public class RandomVariableFromDoubleArrayTest {
	...
	public void testSize() {
		...
		final RandomVariable variable = new RandomVariableFromDoubleArray(0.0, values);
	...
	public void testGetRealizations() {
		...
		final double[] realizations = variable.getRealizations();
	...
	public void testApply() {
		...
		final RandomVariable result = variable.apply(x -> x * 2);
	...
	@Test
	public void testAdd() {
		final double[] values1 = { 1.0, 2.0, 3.0 };
		final RandomVariable variable1 = new RandomVariableFromDoubleArray(0.0, values1);

		final double[] values2 = { 2.0, 3.0, 4.0 };
		final RandomVariable variable2 = new RandomVariableFromDoubleArray(0.0, values2);

		final RandomVariable result = variable1.add(variable2);
	...
	public void testMult() {
		...
		final RandomVariable result = variable1.mult(variable2);
		...
		final RandomVariable result2 = variable1.mult(2.0);
	...
	@Test
	public void testDiv() {
		final double[] values1 = { 2.0, 4.0, 6.0 };
		final RandomVariable variable1 = new RandomVariableFromDoubleArray(0.0, values1);

		final double[] values2 = { 1.0, 2.0, 3.0 };
		final RandomVariable variable2 = new RandomVariableFromDoubleArray(0.0, values2);

		final RandomVariable result = variable1.div(variable2);
		...
		final RandomVariable result2 = variable1.div(2.0);
	...
	public void testAverage() {
		...
		final double expectedAverage = (values[0] + values[1] + values[2]) / values.length;
		final double actualAverage = variable.average().doubleValue();
	...
	public void testVariance() {
		...
		final double expectedVariance = ((values[0] - variable.average().doubleValue()) * (values[0] - variable.average().doubleValue())
		...
		final double actualVariance = variable.variance().doubleValue();
