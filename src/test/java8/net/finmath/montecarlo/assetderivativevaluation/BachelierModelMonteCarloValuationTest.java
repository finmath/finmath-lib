...
public class BachelierModelMonteCarloValuationTest {
	...
	public void testEuropeanCall() throws CalculationException
	{
		...
		for(double optionStrike = 0.75/payoffUnit; optionStrike < 1.25/payoffUnit; optionStrike += 0.05/payoffUnit) {
			...
			final double valueAnalytic	= net.finmath.functions.BachelierModel.bachelierHomogeneousOptionValue(forward, volatility, optionMaturity, optionStrike, payoffUnit);
	...
	public void testEuropeanCallVega() throws CalculationException
	{
		...
		for(double optionStrike = 0.60; optionStrike < 1.50; optionStrike += 0.05) {
			...
			final double vegaFiniteDiffAnalytic	=
					(
							net.finmath.functions.BachelierModel.bachelierHomogeneousOptionValue(forward, volatilityUp, optionMaturity, optionStrike, payoffUnit)
							-
							net.finmath.functions.BachelierModel.bachelierHomogeneousOptionValue(forward, volatilityDown, optionMaturity, optionStrike, payoffUnit)
							)/(2*shift);
