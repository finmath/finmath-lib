...
public class BarrierOptionsTest {
	...
	public void testDownAndInPut() {
		...
		double[] optionStrike = {90, 100, 110};
		double[] barrierValue = {95, 100};
		BarrierType barrierType = BarrierType.DOWN_IN;
		
		double optionValue;
		
		double[][] haughValues = {{2.9586, 2.2845},{6.5677, 5.9085},{11.9752, 11.6465}};
	...
	public void testDownAndInCall() {
		...
		double[][] haughValues = {{7.7627,13.8333},{4.0109, 7.8494},{2.0576, 3.9795}};
	...
	public void testUpAndInPut() {
		boolean isCall = false;
		double[] optionStrike = {90, 100, 110};
		double[] barrierValue = {105};
		BarrierType barrierType = BarrierType.UP_IN;
		
		double optionValue;
		
		double[][] haughValues = {{1.4653},{3.3721},{7.0846}};
	...
	public void testUpAndInCall() {
		...
		double[][] haughValues = {{14.1112},{8.4482},{4.5910}};
	...
	public void testDownAndOutPut() {
		...
		double[] optionStrike = {90, 100, 110};
		double[] barrierValue = {95,100};
		BarrierType barrierType = BarrierType.DOWN_OUT;
		
		double optionValue;
		
		double[][] haughValues = {{2.2798, 3.0000},{2.2947, 3.0000},{2.6252, 3.0000}};
	...
	public void testDownAndOutCall() {
		...
		double[][] haughValues = {{9.0246, 3.0000},{6.7924, 3.0000},{4.8759, 3.0000}};
	...
	public void testUpAndOutPut() {
		...
		double[] optionStrike = {90, 100, 110};
		double[] barrierValue = {105};
		BarrierType barrierType = BarrierType.UP_OUT;
		
		double optionValue;
		
		double[][] haughValues = {{3.7760},{5.4932},{7.5187}};
	...
	public void testUpAndOutCall() {
		...
		double[][] haughValues = {{2.6789},{2.3580},{2.3453}};
