...
import net.finmath.marketdata2.model.curves.CurveFromInterpolationPoints.ExtrapolationMethod;
import net.finmath.marketdata2.model.curves.CurveFromInterpolationPoints.InterpolationEntity;
import net.finmath.marketdata2.model.curves.CurveFromInterpolationPoints.InterpolationMethod;
...
public class CalibrationTest {
	...
	public void testForwardCurveFromDiscountCurve() {
		...
		AnalyticModelFromCurvesAndVols model1 = new AnalyticModelFromCurvesAndVols(new Curve[] { discountCurve , forwardCurveFromDiscountCurve });
	...
	public void testCurvesAndCalibration() throws SolverException {
		...
		AnalyticModelFromCurvesAndVols model2 = new AnalyticModelFromCurvesAndVols( new Curve[] { discountCurve, forwardCurveInterpolation } );
