...
public class MonteCarloBlackScholesModelTest {
	...
	public void testDirectValuation() throws CalculationException {
		...
		final MonteCarloProcessFromProcessModel process = new EulerSchemeFromProcessModel(model, new BrownianMotionFromMersenneRandomNumbers(timeDiscretization, 1 /* numberOfFactors */, numberOfPaths, seed), Scheme.EULER);
